...
if(isset($_POST['submit'])){
    ...
    $fname = mysqli_real_escape_string($conn,$_POST['f_name']);//this function is realated to the special_character to use the encode the data this func is in mysql func
