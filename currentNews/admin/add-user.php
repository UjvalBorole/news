...
if($_SESSION["role"] == '0'){ 
    ...
    if(isset($_POST['save'])){
        ...
        $fname = mysqli_real_escape_string($conn,$_POST['fname']);//this function is realed to the special_character to use the encode the data this func is in mysql func
